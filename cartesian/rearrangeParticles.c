          ...
          while(p)
          {
            ...
            if(deleteFlag==1)
            {
              if(cnt==1)
              {
                ...
                p->next = D->track[i+intX][j][k].head[s]->pt;
                D->track[i+intX][j][k].head[s]->pt = p;
                p=D->track[i][j][k].head[s]->pt;
                cnt=1;
              }
              else
          ...
          while(p)
          {
            ...
            if(deleteFlag==1)
            {
              if(cnt==1)
              {
                p->x=x;   p->y=y;   p->z=z;   
                D->track[i][j][k].head[s]->pt = p->next;
                p->next = D->track[i+intX][j+intY][k+intZ].head[s]->pt;
                D->track[i+intX][j+intY][k+intZ].head[s]->pt = p;
                p=D->track[i][j][k].head[s]->pt;
                cnt=1;
              }
              else
