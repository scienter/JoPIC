...
//lala
    ...
    saveFieldComp(D->EzNowR,name,"/EzR",nx,ny,nxSub,nySub,istart,iend,jstart,jend,numMode,offset);
    saveFieldComp(D->EzNowI,name,"/EzI",nx,ny,nxSub,nySub,istart,iend,jstart,jend,numMode,offset);
