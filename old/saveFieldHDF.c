...
void saveFieldComp_2D(float ***data,char *fileName,char *dataName,int nx,int ny,int nxSub,int nySub,int istart,int iend,int jstart,int jend,int *offSet)
{
    int ii,i,j,k,start;
    float *field;
    int myrank, nTasks;    
...
void saveFieldComp2_2D(float ***data1,float ***data2,char *fileName,char *dataName,int nx,int ny,int nxSub,int nySub,int istart,int iend,int jstart,int jend,int *offSet,int mode)
{
    int ii,i,j,k,start;
    float x,y,z,Ex,Ey,Ez,Bx,By,Bz,factor;
    float *field,*xtic,*ytic,*ztic;
...
void saveFieldComp_3D(float ***data,char *fileName,char *dataName,int nx,int ny,int nz,int nxSub,int nySub,int nzSub,int istart,int iend,int jstart,int jend,int kstart,int kend,int *offSet)
{
    int ii,i,j,k,start;
    float x,y,z,Ex,Ey,Ez,Bx,By,Bz,factor;
    float *field,*xtic,*ytic,*ztic;
...
void saveFieldComp2_3D(float ***data1,float ***data2,char *fileName,char *dataName,int nx,int ny,int nz,int nxSub,int nySub,int nzSub,int istart,int iend,int jstart,int jend,int kstart,int kend,int *offSet,int mode)
{
    int ii,i,j,k,start;
    float x,y,z,Ex,Ey,Ez,Bx,By,Bz,factor;
    float *field,*xtic,*ytic,*ztic;
