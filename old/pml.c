...
float func(float x,float r,int pmlCell)
{
  float result; 

  result=1.0-r*r*x*x/((float)pmlCell)/((float)pmlCell);
  return result;
}
...
void absorb3DC(Domain *D,int position)
{
  ...
  float prevSrC,nowSrC,prevPrC,nowPrC,tmp;
  float dx,dt,dy,dz,rr,y,z;
  float damp11,damp12,damp21,damp22,damp31,damp32,damp41,damp42;
...
void absorb3D(Domain *D,int position)
{
  int istart,iend,jstart,jend,kstart,kend;
  int i,j,k,nxSub,nySub,nzSub,jinit,jfinal,kinit,kfinal,pmlCell;
  float prevSr,nowSr,prevPr,nowPr;
  float dx,dt,dy,dz,rr,y,z;
  float damp11,damp12,damp21,damp22,damp31,damp32,damp41,damp42;
...
void absorb2DC(Domain *D,int position)
{
  ...
  float prevSrC,nowSrC,prevPrC,nowPrC;
  float dx,dt,dy,dz,rr,rd,y,damp11,damp12,damp21,damp22;
...
void absorb2D(Domain *D,int position)
{
  ...
  int i,j,k,nxSub,nySub,nzSub,jinit,jfinal,pmlCell;
  float prevSr,nowSr,prevPr,nowPr;
  float dx,dt,dy,dz,rr,y,damp11,damp12,damp21,damp22;
