...
{
  void movingDomain1D_DSX();
  void movingDomain2D_DSX();
  void movingDomain3D_DSX();
...
void movingDomain2D_DSX(Domain *D)
{
    int i,j,k,istart,iend,jstart,jend,s;
    double x;
    ptclList *p,*tmp,*New;      
    Particle ***particle;
    particle=D->particle;
